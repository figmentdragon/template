...
<section class="no-results not-found">
	<header class="page-header alignwide">
		<?php if ( is_search() ) : ?>
			...
			<h1 class="page-title">
				...
				printf(
					...
					esc_html__( 'Results for "%s"', 'themename' ),
		...
		<?php else : ?>
			...
			<h1 class="page-title"><?php esc_html_e( 'Nothing here', 'themename' ); ?></h1>
		...
		<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
			...
			printf(
				'<p>' . wp_kses(
					...
					__( 'Ready to publish your first post? <a href="%s">Get started here</a>.', 'themename' ),
					array(
						'a' => array(
							'href' => array(),
						),
