...
$wp_customize->add_control( 'short_description_details',
	array(
	'label'    => __( 'Short Description Details', 'themename' ),
...
$wp_customize->add_control( 'button_url_link',
	array(
	'label'    => __( 'Button URL Link', 'themename' ),
	'section'  => 'header_image',
	'type'     => 'text',
	'priority' => 120,
	)
...
$wp_customize->add_section( 'theme_archive_option_section_settings',
	array(
		'title'      => esc_html__( 'Archive Section Setting Options', 'themename' ),
		'priority'   => 100,
		'capability' => 'edit_theme_options',
...
$wp_customize->add_control( 'enable_archive_layout_switch',
	array(
		'label'    => esc_html__( 'Enable Switch/toggle Option on Arcvhives', 'themename' ),
...
$wp_customize->add_control( 'archive_layout_style',
	array(
		'label'    => esc_html__( 'Select Default Layout For Archive Post', 'themename' ),
		'section'  => 'theme_archive_option_section_settings',
		'choices'  => array(
                'archive-list-post-layout' => esc_html__( 'List Post Layout', 'themename' ),
                'archive-grid-post-layout' => esc_html__( 'Grid/Masonry Layout', 'themename' ),
		    ),
		'type'     => 'select',
		'priority' => 30,
	)
...
$wp_customize->add_control( 'archive_layout_grid_column',
	array(
		'label'    => esc_html__( 'Select Number of Grid Column', 'themename' ),
		'section'  => 'theme_archive_option_section_settings',
		'choices'  => array(
                '3-column-arc' => esc_html__( '3-Column Layout', 'themename' ),
                '2-column-arc' => esc_html__( '2-Column Layout', 'themename' ),
		    ),
		'type'     => 'select',
		'priority' => 30,
	)
...
$wp_customize->add_section( 'theme_option_section_settings',
	array(
		'title'      => esc_html__( 'Layout Management', 'themename' ),
		'priority'   => 100,
		'capability' => 'edit_theme_options',
		'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'site_date_layout_option',
	array(
		'label'    => esc_html__( 'Select Date Format', 'themename' ),
		'section'  => 'theme_option_section_settings',
		'choices'  => array(
                'in-time-span' => __( 'Time Span Format', 'themename' ),
                'normal-format' => __( 'Regular Format', 'themename' ),
		    ),
		'type'     => 'select',
		'priority' => 160,
	)
...
$wp_customize->add_control( 'global_layout',
	array(
		'label'    => esc_html__( 'Global Page/Post Sidebar Layout', 'themename' ),
		'section'  => 'theme_option_section_settings',
		'choices'   => array(
			'left-sidebar'  => esc_html__( 'Primary Sidebar - Content', 'themename' ),
			'right-sidebar' => esc_html__( 'Content - Primary Sidebar', 'themename' ),
...
$wp_customize->add_section( 'pagination_section',
	array(
	'title'      => __( 'Pagination Options', 'themename' ),
	'priority'   => 110,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control( 'pagination_type',
	array(
	'label'       => __( 'Pagination Type', 'themename' ),
	'section'     => 'pagination_section',
	'type'        => 'select',
	'choices'               => array(
		'default' => __( 'Default (Older / Newer Post)', 'themename' ),
		'numeric' => __( 'Numeric', 'themename' ),
	    ),
	'priority'    => 100,
	)
);
...
$wp_customize->add_control( 'copyright_text',
	array(
	'label'    => __( 'Footer Copyright Text', 'themename' ),
