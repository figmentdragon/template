...
if ( ! function_exists( 'themename_get_default_theme_options' ) ) :
	...
	function themename_get_default_theme_options() {
        ...
        $defaults['button_text'] = esc_html__( 'About Me', 'themename' );
		...
		$defaults['copyright_text']					= esc_html__( 'Copyright All right reserved', 'themename' );
		$defaults['enable_preloader']				= 1;

		// Pass through filter.
		$defaults = apply_filters( 'themename_filter_default_theme_options', $defaults );
