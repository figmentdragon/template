...
function themename_custom_header_and_bg() {
    ...
    apply_filters( 'themename_custom_header_args',
      array(
  'default-image' => array(
  'url'         => get_stylesheet_directory_uri() . '/assets/images/header_bg.png',
  'thumbnail_url' => get_stylesheet_directory_uri() . '/assets/images/header_bg.png',
  ),
  ...
  register_default_headers( $header_images = array(
    'default-image' => array(
      'url'         => get_stylesheet_directory_uri() . '/assets/images/header_bg.png',
      'thumbnail_url' => get_stylesheet_directory_uri() . '/assets/images/header_bg.png',
      'description' => esc_html__( 'default-image', 'themename' ),
    ),
    'celestialstaff_fire' => array(
      'url'         => get_stylesheet_directory_uri() . '/assets/images/header/header_celestialstaff_fire.png',
      'thumbnail_url' => get_stylesheet_directory_uri() . '/assets/images/header/header_celestialstaff_fire.png',
      'description' => esc_html__( 'celestialstaff_fire', 'themename' ),
    ),
    'celestialstaff_sun' => array(
      'url'       => get_template_directory_uri() . '/assets/images/header/header_celestialstaff_sun.png',
      'thumbnail_url' => get_template_directory_uri() . '/assets/images/header/header_celestialstaff_sun.png',
      'description' => esc_html__( 'celestialstaff_sun', 'themename' ),
    )
  ) );
}
