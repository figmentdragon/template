 ...
 */
class Theme_Name_Custom_Colors {
	...
	public function generate_custom_color_variables( $context = null ) {
		...
		if ( 'd1e4dd' !== strtolower( $background_color ) ) {
			$theme_css .= '--Background: #' . $background_color . ';';
			$theme_css .= '--primary: ' . $this->custom_get_readable_color( $background_color ) . ';';
			$theme_css .= '--secondary: ' . $this->custom_get_readable_color( $background_color ) . ';';
			$theme_css .= '--ButtonBackground: ' . $this->custom_get_readable_color( $background_color ) . ';';
			$theme_css .= '--ButtonText-hover: ' . $this->custom_get_readable_color( $background_color ) . ';';
	...
	public function editor_custom_color_variables() {
		wp_enqueue_style(
			...
			get_theme_file_uri( 'assets/themename/css/custom-color-overrides.css' ),
			array(),
