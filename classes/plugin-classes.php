<?php
if ( !class_exists('Theme_Name_Getting_started') ):

    class Theme_Name_Getting_started
    {

        function __construct()
        {

            add_action( 'wp_ajax_themename_install_plugins', array( $this, 'themename_install_plugins' ) );
        ...
        public static function themename_plugin_status($plugin_class, $plugin_folder, $plugin_file){

            if( class_exists( $plugin_class ) ){

                return array('status' => 'active','string' => esc_html__('Deactivate','themename') );
                ...
                if( file_exists( $path ) ) {
                    ...
                    return array('status' => 'deactivate','string' => esc_html__('Activate','themename') );
                }else{

                    return array('status' => 'not-install','string' => esc_html__('Install & Active','themename') );
        ...
        public static function themename_recommended_plugins(){
            ...
            return $plugin_lists = array(
                ...
                'creativityarchitect-import-companion' => array(
                    'PluginFile' => 'creativityarchitect-import-companion.php',
                    'class' => 'CreativityArchitect_Import_Companion',
                    'setting_page' => esc_url( get_home_url(null, '/').'wp-admin/themes.php?page=creativityarchitect-import-companion' ),
                ),
            );
        ...
        public function themename_install_plugins(){
            ...
            if (! wp_verify_nonce( $nonce, 'themename_ajax_nonce' )) {
            ...
            if( isset( $_POST['single'] ) ){
                ...
                $plugin_lists = $this->themename_recommended_plugins();
            ...
            foreach( $plugin_lists as $key => $plugin ){
                ...
                if( isset( $_POST['single'] ) ){
                    ...
                    $pluginstatus   = $this->themename_plugin_status( $plugin['class'],$key,$plugin['PluginFile'] );
                ...
                if( isset( $_POST['single'] ) && $PluginStatus == 'active' ) {
                    ...
                    esc_html_e('Deactivated' , 'themename');
                    die();
                    ...
                    if( isset( $_POST['single'] ) ) {
                        ...
                        esc_html_e('Activated' , 'themename');
                        die();
                    ...
                    if( file_exists($plugin_dir) ) {
                        ...
                        if( isset( $_POST['single'] ) ) {
                            esc_html_e('Installed & Activated' , 'themename');
                            die();
                        }
            ...
            if( !isset( $_POST['single'] ) ) {
                echo esc_url( get_home_url(null, '/').'wp-admin/themes.php?page=themename-about' );
            }
    ...
    new Theme_Name_Getting_started();
