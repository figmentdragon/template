...
function THEMENAME_setup() {
  ...
  add_editor_style( get_stylesheet_directory() . '/assets/scripts/css/editor-style.css' );

  // let's get language support going, if you need it
  //load_theme_textdomain( 'THEMENAME', get_stylesheet_directory() . '/library/translation' );
    ...
    <article  class="cf">
      <header class="comment-author vcard">
        ...
        */
        ...
        ?>
        <img data-gravatar="http://www.gravatar.com/avatar/<?php echo md5( $bgauthemail ); ?>?s=40" class="load-gravatar avatar avatar-48 photo" height="40" width="40" src="<?php echo get_stylesheet_directory(); ?>/library/images/nothing.gif" />
